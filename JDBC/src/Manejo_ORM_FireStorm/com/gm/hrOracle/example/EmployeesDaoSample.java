...
package Manejo_ORM_FireStorm.com.gm.hrOracle.example;

import java.math.*;
import java.util.Date;
import java.util.Collection;
import Manejo_ORM_FireStorm.com.gm.hrOracle.dao.EmployeesDao;
import Manejo_ORM_FireStorm.com.gm.hrOracle.dto.Employees;
import Manejo_ORM_FireStorm.com.gm.hrOracle.exceptions.EmployeesDaoException;
import Manejo_ORM_FireStorm.com.gm.hrOracle.factory.EmployeesDaoFactory;
...
public class EmployeesDaoSample
{
	...
	/**
	 * Method 'findByDepartments'
	 * 
	 * @param departmentId
	 */
	public static void findByDepartments(int departmentId)
	{
		try {
			EmployeesDao _dao = getEmployeesDao();
			Employees _result[] = _dao.findByDepartments(departmentId);
			for (int i=0; i<_result.length; i++ ) {
				display( _result[i] );
			}
	 ...
	 * @param jobId
	 */
	public static void findByJobs(String jobId)
	{
		try {
			EmployeesDao _dao = getEmployeesDao();
			Employees _result[] = _dao.findByJobs(jobId);
			for (int i=0; i<_result.length; i++ ) {
				display( _result[i] );
			}
