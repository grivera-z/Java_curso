...
import Manejo_ORM_FireStorm.com.gm.hrOracle.factory.*;
import java.util.Date;
import Manejo_ORM_FireStorm.com.gm.hrOracle.dto.*;
import Manejo_ORM_FireStorm.com.gm.hrOracle.exceptions.*;
...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	public Employees[] findByDepartments(int departmentId) throws EmployeesDaoException
	{
	 ...
	 */
	public Employees[] findByJobs(String jobId) throws EmployeesDaoException
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE JOB_ID = ?", new Object[] { jobId } );
	}
